...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>newone Software Installation</h2>
        <h6 class="fw-normal">Please proceed step by step with proper data according to instructions</h6>
    </div>

    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="newone Software Installation"
                            ...
                            <div class="col-md-12">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" name="business_name"
                                           required placeholder="Ex: newone">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <div class="number-input-wrap">
                                        <select name="phone-number" id="phone-number" class="form-select">
