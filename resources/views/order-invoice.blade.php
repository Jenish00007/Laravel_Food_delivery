                        ...
                        <tbody>
                            <tr>
                                <td class="p-10" style="text-align:center">
                                    <img class="mb-2 mail-img-2" src="{{\App\CentralLogics\Helpers::get_full_url('business', $logo?->value?? '', $logo?->storage[0]?->value ?? 'public','favicon')}}"
                                    alt="">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width:150px">
                                                    ...
                                                    <div class="d-block">{{ translate('Order') }}# {{ $order->id }}</div>
                                                ...
                                                <td class="px-3" style="width:100px">
                                                    ...
                                                    <div class="d-block">{{ $address['contact_person_name']  ?? $order->customer?->f_name . ' ' . $order->customer?->l_name }}</div>
                                                    <div  class="d-block">
            ...
            <tr>
                <td style="text-align:center" >
                    ...
                    <div class="copyright"  style="text-align:center" id="">
                        {{translate('Please')}}
                        <a  class="text-base" href="mailto:{{ $BusinessData['email_address'] }}">{{ translate('contact us') }}</a>   {{  translate('for any queries, we’re always happy to help.') }}
                    </div>
                    <div class="copyright"  style="text-align:center" id="mail-copyright">
                        {{ $BusinessData['footer_text'] ?? translate('Copyright 2023 newone. All right reserved') }}
                    </div>
                </td>
            </tr>
        </tbody>
