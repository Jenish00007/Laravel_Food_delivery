    ...
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
            <div>
                ...
                <p class="m-0">
                    {{translate('connect_drivemond_system_with_newone')}}
                </p>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="border rounded d-flex flex-wrap gap-2 align-items-center p-3 p-sm-4">
                                <div class="w-160px flex-grow-1">
                                    ...
                                    <p class="fs-12 m-0">
                                        {{translate('Enable the switch to activate the purchased Software- Drivemond ride-sharing in the newone system. You must input the correct information to make sure the functionality works properly.')}}
                                    </p>
                                </div>
                            ...
                            <div class="row g-4 mt-2">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="p-3 p-sm-4 bg-soft-secondary rounded">
                                        <label
                                            class="form-label">{{ (\App\CentralLogics\Helpers::get_business_data('business_name') ?? "newone" ) . ' ' .translate('System Token') }}
                                            <i class="tio-info-outined text-primary"
                                               title="{{ translate("Click on the Generate Token button, It will automatically generate the newone System token and insert it into the input field.") }}"
                                               data-toggle="tooltip"></i>
                                        </label>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 pt-0 px-lg-5">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="">
                                    ...
                                    <h5 class="mb-2">{{(\App\CentralLogics\Helpers::get_business_data('business_name') ?? "newone" ) . ' ' .translate('System Token Generate')}}</h5>
                                    <p>
                                        ...
                                        {{(\App\CentralLogics\Helpers::get_business_data('business_name') ?? "newone" ) . ' ' .translate('System Token Generate')}}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="pb-1">
                            <i class="text-dark">{{translate('Note :  Follow the same steps on Drivemond to successfully connect newone with Drivemond')}}</i>
                        </div>
                    </div>
                </div>
            </div>
