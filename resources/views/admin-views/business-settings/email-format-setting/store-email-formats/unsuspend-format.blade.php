    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php($mail_status=\App\Models\BusinessSetting::where('key','unsuspend_mail_status_store')->first())
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{translate('Send_Mail_on_Unsuspend_a_Store')}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Admin_unsuspend_a_store,_the_store_will_get_a_unsuspend_mail_from_the_system.')}}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{translate('Want_to_enable_Store_unsuspend_mail?')}}"
                                data-title-off="{{translate('Want_to_disable_Store_unsuspend_mail?')}}"
                                data-text-on="<p>{{translate('If_enabled,_Store_will_receive_an_email_for_account_unsuspension.')}}</p>"
                                data-text-off="<p>{{translate('If_disabled,_Store_will_not_receive_an_email_for_account_unsuspension.')}}</p>"
                        ...
                        <form action="{{route('admin.business-settings.email-status',['store','unsuspend',$mail_status == '1'?0:1])}}" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    <div class="d-flex flex-wrap justify-content-between __gap-15px mt-2 mb-5">
                                        @php($data=\App\Models\EmailTemplate::withoutGlobalScope('translate')->with('translations')->where('type','store')->where('email_type', 'unsuspend')->first())
