    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php($mail_status=\App\Models\BusinessSetting::where('key','unsuspend_mail_status_dm')->first())
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.business-settings.email-status',['dm','unsuspend',$mail_status == '1'?0:1])}}" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
