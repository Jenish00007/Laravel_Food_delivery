    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{translate('Send_Mail_on_Unsuspend_a_Customer')}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Admin_unsuspends_a_customer’s_,_the_customer_will_get_a_unsuspend_mail_from_the_system.')}}">
                                    <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.Send_Mail_on_unsuspend_a_Customer') }}">
                                </span>
                            </h5>
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{translate('Want_to_enable_Customer_unsuspend_mail?')}}"
                                data-title-off="{{translate('Want_to_disable_Customer_unsuspend_mail?')}}"
                                data-text-on="<p>{{translate('If_enabled,_Customer_will_receive_an_email_for_account_unsuspension.')}}</p>"
                                data-text-off="<p>{{translate('If_disabled,_Customer_will_not_receive_an_email_for_account_unsuspension.')}}</p>"
                        ...
                        <form action="{{route('admin.business-settings.email-status',['user','unsuspend',$mail_status == '1'?0:1])}}" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.business-settings.email-setup', ['user','unsuspend']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
