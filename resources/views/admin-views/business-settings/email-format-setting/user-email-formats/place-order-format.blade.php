    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php($mail_status=\App\Models\BusinessSetting::where('key','place_order_mail_status_user')->first()?->value ??  '0' )
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.business-settings.email-status',['user','place-order',$mail_status == '1'?0:1])}}" method="get" id="mail-status_form">
                                            </form>
                    </div>
                </div>
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    <div class="d-flex flex-wrap justify-content-between __gap-15px mt-2 mb-5">
                                        @php($data=\App\Models\EmailTemplate::withoutGlobalScope('translate')->where('type','user')->where('email_type', 'new_order')->first())
