                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_user_login_from_their_respective_system,_the_Admin_gets_notified_via_email.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{translate('Want_to_enable_Login_mail?')}}"
                                       data-title-off="{{translate('Want_to_disable_Login_mail?')}}"
                                       data-text-on="<p>{{translate('If_enabled,_Admin_will_receive_an_automated_email_on_every_login_from_all_users')}}</p>"
                                       data-text-off="<p>{{translate('If_disabled,_Admin_will_not_receive_an_automated_email_on_every_login_of_users')}}</p>"
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    <div class="d-flex flex-wrap justify-content-between __gap-15px mt-2 mb-5">
                                        @php($data=\App\Models\EmailTemplate::withoutGlobalScope('translate')->where('type','admin')->where('email_type', 'login')->first())
