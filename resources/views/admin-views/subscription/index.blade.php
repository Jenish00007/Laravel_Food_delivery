                                    ...
                                    <div class="inner-div">
                                        ...
                                        <div class="py-5 mt-4">
                                            <div class="info-text text-center">
                                                Store will pay 15% commission to newone from each order. You will get access of all the features and options  in store panel , app and interaction with user.
                                            </div>
                                        </div>
                                        <div class="text-center">
